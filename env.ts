...
const BUNDLE_IDS = {
  development: 'com.snap-spent.development',
  preview: 'com.snap-spent.preview',
  production: 'com.snap-spent',
} as const;
...
const SCHEMES = {
  development: 'snap-spent',
  preview: 'snap-spent.preview',
  production: 'snap-spent',
} as const;

const NAME = 'snap-spent';
